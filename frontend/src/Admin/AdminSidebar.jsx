...
export default function AdminSidebar({
  activePage, onNavigate, onBack, queries,
  // Mobile drawer props
  ...
  return (
    <div style={{
      ...
      // On mobile drawer it fills the fixed-positioned container's height.
      // On desktop it fills the 100vh layout.
      height: '100%',
      minHeight: '100vh',
    }}>
      ...
      <div>
        ...
        <div style={{ padding: '22px 18px 16px', display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between' }}>
          <div>
            <img
              src="/shnoor-logo.png"
              alt="SHNOOR"
            ...
            />
            <p style={{
              fontSize: 10, color: '#0D9488', marginTop: 6,
          ...
          {isMobileDrawer && (
            <button
              ...
              style={{
                ...
                borderRadius: 6, color: textSecondary, flexShrink: 0,
              }}
            >
        ...
        {/* Divider */}
        <div style={{ height: 1, background: 'rgba(128,128,128,0.1)', margin: '0 0 8px' }} />
